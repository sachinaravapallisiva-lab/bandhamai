...
const handleSrc = guru.slice(guru.indexOf("export async function handleGuruChat"));
const refuseAt = handleSrc.indexOf("looksLikeGunMilanQuestion");
const xaiAt = handleSrc.indexOf("XAI_API_KEY is not configured");
assert(refuseAt >= 0 && xaiAt > refuseAt, "refuse without a report does not need the model key");
