...
assert(meetupRail.includes('flex: "0 0 "'), "meetup rail does not shrink after the dash");
assert(meetupRail.includes("SIDEBAR_RAIL_BASIS"), "meetup rail width matches the Account bar");
assert(meetupRail.includes("minWidth: SIDEBAR_RAIL_BASIS"), "meetup rail min width stays 240");
