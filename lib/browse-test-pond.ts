...
import { BROWSE_PIN_CAP, takePinnedIds } from "./browse-pin";
...
/** Twenty Soft Minimal cards. Photo coming soon. No stock faces. */
export const BROWSE_TEST_SEEDS: TestSeed[] = [
  { id: "test-pond-01", name: "Arjun Mehta", city: "Dallas", work: "Software engineer", education: "MS", langs: "Gujarati", diet: "Vegetarian", online: true, note: "I cook on Sundays and keep a small garden on the balcony.", pinned: true },
  ...
  { id: "test-pond-04", name: "Diya Kapoor", city: "Chicago", work: "Architect", education: "MArch", langs: "Hindi", diet: "Vegetarian", online: false, note: "I sketch buildings and cook dal when friends come over.", pinned: true },
  ...
  { id: "test-pond-07", name: "Sameer Joshi", city: "San Jose", work: "Hardware engineer", education: "MS", langs: "Marathi", diet: "Vegetarian", online: true, note: "I repair old radios and host chai on the patio.", pinned: true },
  ...
  { id: "test-pond-10", name: "Tanvi Desai", city: "Houston", work: "Teacher", education: "MEd", langs: "Gujarati", diet: "Vegetarian", online: false, note: "I teach fifth grade and grow tomatoes on the porch.", pinned: true },
  ...
  { id: "test-pond-13", name: "Karan Malhotra", city: "New Jersey", work: "Physician", education: "MD", langs: "Punjabi", diet: "Vegetarian", online: true, note: "Hospital weeks are long. I want someone who likes quiet evenings.", pinned: true },
  ...
  { id: "test-pond-16", name: "Anika Sharma", city: "Denver", work: "Therapist", education: "MSW", langs: "Hindi", diet: "Vegetarian", online: false, note: "I keep evenings screen light and mornings for a walk.", pinned: true },
