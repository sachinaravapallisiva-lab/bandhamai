...
type TabType = "profile" | "discover" | "matches" | "inbox" | "settings";
...
interface UserProfile {
  ...
  profession: string;
  income?: string;
  speedDatingAnswers: Record<string, string>;
  verified: boolean;
  online: boolean;
}
...
const speedDatingQuestions = [
  ...
  "What quality is absolutely essential in a partner?",
];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-3xl shadow-lg p-6 border border-gray-200">
                ...
                <p className="text-xs text-gray-600">Add speed dating answers to increase strength →</p>
              </div>
            </div>
          </div>
        )}
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm font-bold text-gray-900">{match.compatibility}%</span>
                      </div>
                    </div>
          ...
          <div>
            ...
            <div className="max-w-2xl mx-auto space-y-3">
              {sampleMatches.map((match) => (
                <div
                  key={match.id}
                  className="bg-white rounded-2xl shadow-lg p-4 border border-gray-200 hover:shadow-xl transition-all cursor-pointer"
                >
