  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex gap-4 border-b p-4 bg-white">
        <button onClick={() => setTab("profile")} className="px-4 py-2 font-bold text-gray-600">Profile</button>
        <button onClick={() => setTab("discover")} className="px-4 py-2 font-bold text-gray-600">Discover</button>
        <button onClick={() => setTab("inbox")} className="px-4 py-2 font-bold text-gray-600">Inbox</button>
      </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-6">
              <div className="bg-white rounded-lg shadow p-4">
                <div className="text-4xl text-center mb-4">Person1</div>
              ...
              <div className="bg-white rounded-lg shadow p-4">
                <div className="text-4xl text-center mb-4">Person2</div>
              ...
              <div className="bg-white rounded-lg shadow p-4">
                <div className="text-4xl text-center mb-4">Person3</div>
        ...
        {tab === "inbox" && (
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="bg-white rounded-lg shadow p-4">
                <h3 className="font-bold">Isha</h3>
                <p className="text-gray-600 text-sm">How are you?</p>
              </div>
              <div className="bg-white rounded-lg shadow p-4">
                <h3 className="font-bold">Neha</h3>
